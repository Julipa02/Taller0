...
public class CalculadoraEstadisticas
{
	...
	//requisito
	public String atletasPorNombre(String nombreAtleta)
	{
		Pais resultado = null;
		String resultado_final = null;
		for (Atleta nombre: atletas)
		{
			String nombre_buscar = nombre.darNombre();
			if (nombre_buscar.equals(nombreAtleta))
			{
				resultado = nombre.darPais();
				resultado_final = resultado.darNombre();
			}
		}
