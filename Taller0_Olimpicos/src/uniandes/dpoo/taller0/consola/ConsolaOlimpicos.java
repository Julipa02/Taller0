...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre del atleta");
	...
	//Requisitos
	private void ejecutarAtletas()
	{
		String nombre_atleta = input("Por favor ingrese el nombre del atleta");
		String nombre_pais = calculadora.atletasPorNombre(nombre_atleta);
		if (nombre_pais == null)
		{
			System.out.println("No existe atleta");
		}
		else
		{
			System.out.println(nombre_pais);
		}
	}
